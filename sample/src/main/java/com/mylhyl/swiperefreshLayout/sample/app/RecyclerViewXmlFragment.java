...
import com.mylhyl.rslayout.SwipeRefreshRecyclerView;
...
public class RecyclerViewXmlFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,
        OnListLoadListener {
    ...
    public RecyclerViewXmlFragment() {
    }

    public static RecyclerViewXmlFragment newInstance() {
        RecyclerViewXmlFragment fragment = new RecyclerViewXmlFragment();
        return fragment;
    }

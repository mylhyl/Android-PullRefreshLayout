 ...
 */
public class DemoSwipeRefreshExpandableListFragment extends SwipeRefreshExpandableListFragment {
    ...
    public static DemoSwipeRefreshExpandableListFragment newInstance() {
        return new DemoSwipeRefreshExpandableListFragment();
    }
